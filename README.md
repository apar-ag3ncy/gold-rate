...
**Current status: all 7 phases done.** Put it online for ₹0: `docs/DEPLOY-VERCEL.md` (one Vercel project – the API runs inside it – plus a free cron service) or `docs/DEPLOY-ORACLE.md` (one free Oracle Cloud server, one script). Paid alternative in `docs/DEPLOYMENT.md`; go-live steps in `docs/GO-LIVE.md`; day-to-day in `docs/RUNBOOK.md`.
